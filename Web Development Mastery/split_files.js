...
const filePath = 'HTML Mastery.html';
const cssPath = 'Using Style for HTML Mastery.css';
const jsPath = 'Using JS for HTML Mastery.js';
...
for (let i = 0; i < lines.length; i++) {
    ...
    if (state === 'HTML' && /^\s*<style id="baseStyles">\s*$/.test(line)) {
        state = 'CSS';
        outHtml.push('  <link rel="stylesheet" href="Using Style for HTML Mastery.css">');
        continue;
        ...
        state = 'JS';
        outHtml.push('  <script src="Using JS for HTML Mastery.js"></script>');
        continue;
